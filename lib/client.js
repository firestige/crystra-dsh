...
function createActionPresentationView({
  ...
  return function CrystraExecutionPresentationView({ node, technicalDetails }) {
    ...
    const [open, setOpen] = React3.useState(presentation.defaultOpen);
    const [copyState, setCopyState] = React3.useState("idle");
    const bodyRef = React3.useRef(null);
    const previousState = React3.useRef(presentation.state);
    const copyPending = React3.useRef(false);
    const copyEpoch = React3.useRef(0);
    const copyTimer = React3.useRef(null);
    React3.useEffect(() => {
    ...
    if (presentation.layer === "final" && presentation.state === "completed") {
      ...
      return React3.createElement(
        ...
        React3.createElement(MessageText2, { text: presentation.body }),
        React3.createElement("div", {
          className: "crystra-answer-actions",
          "data-crystra-answer-actions": "true"
        }, React3.createElement(Tooltip2, { label, side: "bottom" }, React3.createElement("button", {
          type: "button",
          className: "crystra-answer-action",
          "aria-label": label,
          "data-copy-state": copyState,
          onClick: onCopy
        }, React3.createElement(copyState === "copied" ? IconCheckOutline162 : IconCopyOutline162, null))))
      );
    }
    const waiting = presentation.state === "waiting";
    const expandable = (presentation.body !== void 0 || technicalDetails !== void 0) && !waiting;
    const body = presentation.body === void 0 && technicalDetails === void 0 ? void 0 : React3.createElement("div", {
      ref: bodyRef,
    ...
    }, presentation.body === void 0 ? null : React3.createElement("pre", {
      style: { margin: 0, maxHeight: "20rem", overflow: "auto", whiteSpace: "pre-wrap", wordBreak: "break-word" }
    }, presentation.body), technicalDetails === void 0 ? null : React3.createElement(
      "details",
      null,
      React3.createElement("summary", null, "Technical details"),
      JsonTree2 === void 0 ? React3.createElement("pre", null, JSON.stringify(technicalDetails, null, 2)) : React3.createElement(JsonTree2, { data: technicalDetails, label: "CRYSTRA presentation", copyable: true, expandTopLevel: true })
    ));
    return React3.createElement(DisclosureRow2, {
      icon: React3.createElement(StateDot2, { state: DOT_STATE[presentation.state], size: 10 }),
      ...
      collapsedContent: React3.createElement("span", {
...
function createCrystraCommandView(options) {
  ...
  const { React: React3, inventory } = options;
  return function CrystraCommandView({ node }) {
    ...
    const inventoryState = inventory === void 0 ? void 0 : React3.useSyncExternalStore(inventory.subscribe, inventory.getSnapshot, inventory.getSnapshot);
...
function summaryItem(React3, label, value, extra = {}) {
  return React3.createElement(
    "div",
    { className: "crystra-delivery-summary-item", ...extra },
    React3.createElement("dt", null, label),
    React3.createElement("dd", null, value)
  );
}
function statePanel(React3, StateDot2, role, code, message2) {
  return React3.createElement(
    "section",
    {
    ...
    React3.createElement("h2", { className: "crystra-delivery-heading", id: "crystra-delivery-view-title" }, "Delivery"),
    React3.createElement(
      "p",
      null,
      React3.createElement(StateDot2, { state: role === "alert" ? "error" : "ongoing", size: 10 }),
      " ",
      message2
    ),
    code === void 0 ? null : React3.createElement("code", null, code)
  );
}
...
function identityCard(React3, primitives, label, value, displayValue = value) {
  ...
  const exact = React3.createElement("code", {
    "aria-label": `${label}: ${value}`,
    "data-crystra-delivery-identity": label,
    title: value
  }, displayValue);
  const copied = copiedLabel === label;
  const control = React3.createElement(
    Tooltip2,
    { label: copied ? `${label} copied` : `Copy ${label}`, side: "bottom" },
    React3.createElement(Button2, {
      "aria-label": `Copy ${label}`,
      icon: React3.createElement(copied ? IconCheckOutline162 : IconCopyOutline162, null),
  ...
  return React3.createElement(
    ...
    React3.createElement("dt", null, label),
    React3.createElement("dd", null, exact, control)
  );
}
function createSessionDeliveryView(React3, primitives = {}) {
  if (typeof React3?.createElement !== "function" || typeof React3?.useSyncExternalStore !== "function") {
  ...
  return function SessionDeliveryView({ sessionId, source }) {
    const [identitiesOpen, setIdentitiesOpen] = typeof React3.useState === "function" ? React3.useState(false) : [false, () => void 0];
    const [copiedLabel, setCopiedLabel] = typeof React3.useState === "function" ? React3.useState("") : ["", () => void 0];
    const state = React3.useSyncExternalStore(
      (notify) => safeSubscribe(source, notify),
      () => safeSnapshot(source),
      () => safeSnapshot(source)
    );
    if (state.kind === "loading") return statePanel(React3, StateDot2, "status", void 0, "Loading Delivery\u2026");
    if (state.kind === "error") return statePanel(React3, StateDot2, "alert", state.code ?? "DELIVERY_PROJECTION_UNAVAILABLE", state.message ?? "Execution projection unavailable");
    const view = state.view;
    if (state.kind !== "ready" || view?.sessionCorrelation !== sessionId) {
      return statePanel(React3, StateDot2, "alert", "DELIVERY_PROJECTION_CORRUPT", "Delivery projection invalid");
    }
    if (view.kind === "UNBOUND") return statePanel(React3, StateDot2, "status", void 0, "No Delivery bound to this Session");
    ...
    const summary = [
      summaryItem(React3, "Status", React3.createElement(
        "span",
        { className: "crystra-delivery-status" },
        React3.createElement(StateDot2, { state: statusState(delivery, failed), size: 10 }),
        React3.createElement(Pill2, { "aria-label": `Delivery status ${statusLabel}` }, statusLabel)
      )),
      summaryItem(React3, "Workflow", workflowLabel),
      ...
      ...delivery.terminal === null ? [] : [summaryItem(React3, "Outcome", delivery.terminal.outcome, { "data-crystra-delivery-conditional": "terminal" })],
      summaryItem(React3, "Elapsed", duration(delivery.timing.elapsedMs)),
      summaryItem(React3, "Started", new Date(delivery.timing.startedAt).toISOString()),
      ...delivery.terminal === null ? [] : [summaryItem(React3, "Ended", new Date(delivery.terminal.finishedAt).toISOString())]
    ];
    return React3.createElement(
      "section",
      {
      ...
      React3.createElement("h2", { className: "crystra-delivery-heading", id: "crystra-delivery-view-title" }, "Delivery"),
      React3.createElement("dl", { "aria-label": "Delivery summary", "data-crystra-delivery-summary": "true", className: "crystra-delivery-summary" }, summary),
      React3.createElement(
        DisclosureRow2,
        {
          title: "Identity details",
          icon: React3.createElement(StateDot2, { state: statusState(delivery, failed), size: 10 }),
          open: identitiesOpen,
          expandable: true,
          expandOnRowClick: true,
          onToggle: () => setIdentitiesOpen((open) => !open),
          collapsedContent: React3.createElement("code", { className: "crystra-delivery-preview" }, delivery.deliveryId)
        },
        React3.createElement(
          "dl",
          { "aria-label": "Delivery identity", className: "crystra-delivery-identities" },
          identityRows.map(([label, value, displayValue]) => identityCard(React3, {
            Button: Button2,
            IconCheckOutline16: IconCheckOutline162,
            IconCopyOutline16: IconCopyOutline162,
            Tooltip: Tooltip2,
      ...
      delivery.error === null ? null : React3.createElement("section", {
        className: "crystra-delivery-condition",
        "data-crystra-delivery-conditional": "error",
        role: "alert"
      }, React3.createElement("h3", null, "Failure diagnostic"), React3.createElement("code", null, delivery.error.code))
    );
  };
}
...
function createSidebarResources(React3, WorkspaceBrowser, inventory) {
  return function CrystraSidebarResources(props) {
    const [workspaceExpanded, setWorkspaceExpanded] = React3.useState(() => persisted("crystra.sidebar.workspace.expanded.v1"));
    const [deliveryExpanded, setDeliveryExpanded] = React3.useState(() => persisted("crystra.sidebar.delivery.expanded.v1"));
    const selectedSessionId = props.useSessions((state2) => state2.current);
    const state = React3.useSyncExternalStore(inventory.subscribe, inventory.getSnapshot, inventory.getSnapshot);
    const view = React3.useMemo(() => projectDeliveryInventory(state, { selectedSessionId }), [state, selectedSessionId]);
    const toggle = (kind) => {
      if (kind === "workspace") {
    ...
    const header = (id2, label, expanded, kind) => React3.createElement("button", {
      type: "button",
    ...
    }, React3.createElement("span", { "aria-hidden": "true" }, expanded ? "\u25BE" : "\u25B8"), label);
    return React3.createElement(
      "div",
      ...
      React3.createElement(
        ...
        workspaceExpanded && React3.createElement("div", { id: "crystra-sidebar-workspace", className: "crystra-sidebar-resource-content" }, React3.createElement(WorkspaceBrowser, props))
      ),
      React3.createElement(
        "section",
        ...
        deliveryExpanded && React3.createElement("div", {
          id: "crystra-sidebar-delivery",
          className: "crystra-sidebar-resource-content",
          role: view.kind === "error" ? "alert" : "region",
          "aria-live": "polite"
        }, view.kind === "ready" ? React3.createElement("div", { role: "list", "aria-label": "Deliveries" }, view.rows.map((row) => React3.createElement("button", {
          key: row.deliveryId,
          type: "button",
          role: "listitem",
        ...
        }, React3.createElement("span", null, row.label), React3.createElement("span", {
          className: `crystra-delivery-status crystra-delivery-status-${row.availability}`
        }, row.statusLabel)))) : React3.createElement("div", { role: view.role }, view.label))
      )
    );
  };
}
function applyDeliverySidebar(ctx, { React: React3, workspaceUi: workspaceUi2, inventory }) {
  installStyle();
  const originalSlots = ctx.slots;
  const slots = Object.create(originalSlots);
  slots.register = (definition, component) => definition?.name === "sidebar.workspaces" ? originalSlots.register(definition, createSidebarResources(React3, component, inventory)) : originalSlots.register(definition, component);
  slots.inject = (name4, factory) => originalSlots.inject(name4, factory);
...
// modules/execution/src/client/browser-entry.js
var name = "crystra-execution-client";
...
function parseTypenames(typenames, types) {
  return typenames.trim().split(/^|\s+/).map(function(t2) {
    var name4 = "", i2 = t2.indexOf(".");
    if (i2 >= 0) name4 = t2.slice(i2 + 1), t2 = t2.slice(0, i2);
    if (t2 && !types.hasOwnProperty(t2)) throw new Error("unknown type: " + t2);
    return { type: t2, name: name4 };
  });
}
...
function get(type2, name4) {
  for (var i2 = 0, n2 = type2.length, c2; i2 < n2; ++i2) {
    if ((c2 = type2[i2]).name === name4) {
      return c2.value;
    }
  }
}
function set(type2, name4, callback) {
  for (var i2 = 0, n2 = type2.length; i2 < n2; ++i2) {
    if (type2[i2].name === name4) {
      type2[i2] = noop, type2 = type2.slice(0, i2).concat(type2.slice(i2 + 1));
      break;
    }
  }
  if (callback != null) type2.push({ name: name4, value: callback });
  return type2;
}
...
function namespace_default(name4) {
  var prefix = name4 += "", i2 = prefix.indexOf(":");
  if (i2 >= 0 && (prefix = name4.slice(0, i2)) !== "xmlns") name4 = name4.slice(i2 + 1);
...
function attrConstant(name4, value) {
  return function() {
...
function attrFunction(name4, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (v2 == null) this.removeAttribute(name4);
    else this.setAttribute(name4, v2);
  };
}
...
function attr_default(name4, value) {
  var fullname = namespace_default(name4);
  if (arguments.length < 2) {
    var node = this.node();
...
function styleConstant(name4, value, priority) {
  return function() {
    this.style.setProperty(name4, value, priority);
  };
}
function styleFunction(name4, value, priority) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (v2 == null) this.style.removeProperty(name4);
    else this.style.setProperty(name4, v2, priority);
  };
}
function style_default(name4, value, priority) {
  return arguments.length > 1 ? this.each((value == null ? styleRemove : typeof value === "function" ? styleFunction : styleConstant)(name4, value, priority == null ? "" : priority)) : styleValue(this.node(), name4);
}
...
function propertyConstant(name4, value) {
  return function() {
    this[name4] = value;
  };
}
function propertyFunction(name4, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (v2 == null) delete this[name4];
    else this[name4] = v2;
  };
}
function property_default(name4, value) {
  return arguments.length > 1 ? this.each((value == null ? propertyRemove : typeof value === "function" ? propertyFunction : propertyConstant)(name4, value)) : this.node()[name4];
}
...
ClassList.prototype = {
  add: function(name4) {
    var i2 = this._names.indexOf(name4);
    if (i2 < 0) {
...
function classed_default(name4, value) {
...
function append_default(name4) {
  var create2 = typeof name4 === "function" ? name4 : creator_default(name4);
...
function insert_default(name4, before) {
  var create2 = typeof name4 === "function" ? name4 : creator_default(name4), select = before == null ? constantNull : typeof before === "function" ? before : selector_default(before);
  return this.select(function() {
...
var ENDING = 5;
var ENDED = 6;
function schedule_default(node, name4, id2, index, group, timing) {
...
function interrupt_default(node, name4) {
  var schedules = node.__transition, schedule, active, empty2 = true, i2;
  if (!schedules) return;
  name4 = name4 == null ? null : name4 + "";
  for (i2 in schedules) {
    if ((schedule = schedules[i2]).name !== name4) {
      empty2 = false;
      continue;
    }
...
function interrupt_default2(name4) {
  return this.each(function() {
    interrupt_default(this, name4);
  });
}

// node_modules/d3-transition/src/transition/tween.js
function tweenRemove(id2, name4) {
  var tween0, tween1;
  return function() {
...
function tweenFunction(id2, name4, value) {
  var tween0, tween1;
  ...
  return function() {
    ...
    if (tween !== tween0) {
      ...
      for (var t2 = { name: name4, value }, i2 = 0, n2 = tween1.length; i2 < n2; ++i2) {
        if (tween1[i2].name === name4) {
          tween1[i2] = t2;
          break;
        }
...
function tween_default(name4, value) {
  var id2 = this._id;
  name4 += "";
  if (arguments.length < 2) {
    var tween = get2(this.node(), id2).tween;
    for (var i2 = 0, n2 = tween.length, t2; i2 < n2; ++i2) {
      if ((t2 = tween[i2]).name === name4) {
        return t2.value;
      }
    }
    return null;
  }
  return this.each((value == null ? tweenRemove : tweenFunction)(id2, name4, value));
}
function tweenValue(transition2, name4, value) {
  var id2 = transition2._id;
  transition2.each(function() {
    var schedule = set2(this, id2);
    (schedule.value || (schedule.value = {}))[name4] = value.apply(this, arguments);
  });
  return function(node) {
    return get2(node, id2).value[name4];
  };
}
...
function attrConstant2(name4, interpolate, value1) {
  var string00, string1 = value1 + "", interpolate0;
  return function() {
    var string0 = this.getAttribute(name4);
...
function attrFunction2(name4, interpolate, value) {
  var string00, string10, interpolate0;
  return function() {
    var string0, value1 = value(this), string1;
    if (value1 == null) return void this.removeAttribute(name4);
    string0 = this.getAttribute(name4);
    string1 = value1 + "";
...
function attr_default2(name4, value) {
  var fullname = namespace_default(name4), i2 = fullname === "transform" ? interpolateTransformSvg : interpolate_default;
  return this.attrTween(name4, typeof value === "function" ? (fullname.local ? attrFunctionNS2 : attrFunction2)(fullname, i2, tweenValue(this, "attr." + name4, value)) : value == null ? (fullname.local ? attrRemoveNS2 : attrRemove2)(fullname) : (fullname.local ? attrConstantNS2 : attrConstant2)(fullname, i2, value));
}

// node_modules/d3-transition/src/transition/attrTween.js
function attrInterpolate(name4, i2) {
  return function(t2) {
    this.setAttribute(name4, i2.call(this, t2));
  };
}
...
function attrTween(name4, value) {
  var t0, i0;
  function tween() {
    var i2 = value.apply(this, arguments);
    if (i2 !== i0) t0 = (i0 = i2) && attrInterpolate(name4, i2);
    return t0;
  }
  tween._value = value;
  return tween;
}
function attrTween_default(name4, value) {
  var key = "attr." + name4;
...
function start(name4) {
  return (name4 + "").trim().split(/^|\s+/).every(function(t2) {
    var i2 = t2.indexOf(".");
    if (i2 >= 0) t2 = t2.slice(0, i2);
    return !t2 || t2 === "start";
  });
}
function onFunction(id2, name4, listener) {
  var on0, on1, sit = start(name4) ? init : set2;
  return function() {
    var schedule = sit(this, id2), on2 = schedule.on;
    if (on2 !== on0) (on1 = (on0 = on2).copy()).on(name4, listener);
    schedule.on = on1;
  };
}
function on_default2(name4, listener) {
  var id2 = this._id;
  return arguments.length < 2 ? get2(this.node(), id2).on.on(name4) : this.each(onFunction(id2, name4, listener));
}
...
function select_default2(select) {
  var name4 = this._name, id2 = this._id;
  if (typeof select !== "function") select = selector_default(select);
  for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j2 = 0; j2 < m; ++j2) {
    for (var group = groups[j2], n2 = group.length, subgroup = subgroups[j2] = new Array(n2), node, subnode, i2 = 0; i2 < n2; ++i2) {
      if ((node = group[i2]) && (subnode = select.call(node, node.__data__, i2, group))) {
        if ("__data__" in node) subnode.__data__ = node.__data__;
        subgroup[i2] = subnode;
        schedule_default(subgroup[i2], name4, id2, i2, subgroup, get2(node, id2));
      }
    }
  }
  return new Transition(subgroups, this._parents, name4, id2);
}
...
function selectAll_default2(select) {
      ...
      if (node = group[i2]) {
        for (var children2 = select.call(node, node.__data__, i2, group), child, inherit2 = get2(node, id2), k2 = 0, l2 = children2.length; k2 < l2; ++k2) {
          if (child = children2[k2]) {
            schedule_default(child, name4, id2, k2, children2, inherit2);
          }
        }
  ...
  return new Transition(subgroups, parents, name4, id2);
}
...
function styleNull(name4, interpolate) {
  var string00, string10, interpolate0;
  return function() {
    var string0 = styleValue(this, name4), string1 = (this.style.removeProperty(name4), styleValue(this, name4));
    return string0 === string1 ? null : string0 === string00 && string1 === string10 ? interpolate0 : interpolate0 = interpolate(string00 = string0, string10 = string1);
  };
}
function styleRemove2(name4) {
  return function() {
    this.style.removeProperty(name4);
  };
}
function styleConstant2(name4, interpolate, value1) {
  var string00, string1 = value1 + "", interpolate0;
  return function() {
...
function styleFunction2(name4, interpolate, value) {
  var string00, string10, interpolate0;
  return function() {
    var string0 = styleValue(this, name4), value1 = value(this), string1 = value1 + "";
    if (value1 == null) string1 = value1 = (this.style.removeProperty(name4), styleValue(this, name4));
    return string0 === string1 ? null : string0 === string00 && string1 === string10 ? interpolate0 : (string10 = string1, interpolate0 = interpolate(string00 = string0, value1));
  };
}
function styleMaybeRemove(id2, name4) {
  var on0, on1, listener0, key = "style." + name4, event = "end." + key, remove2;
  return function() {
    var schedule = set2(this, id2), on2 = schedule.on, listener = schedule.value[key] == null ? remove2 || (remove2 = styleRemove2(name4)) : void 0;
    if (on2 !== on0 || listener0 !== listener) (on1 = (on0 = on2).copy()).on(event, listener0 = listener);
    schedule.on = on1;
  };
}
function style_default2(name4, value, priority) {
  var i2 = (name4 += "") === "transform" ? interpolateTransformCss : interpolate_default;
  return value == null ? this.styleTween(name4, styleNull(name4, i2)).on("end.style." + name4, styleRemove2(name4)) : typeof value === "function" ? this.styleTween(name4, styleFunction2(name4, i2, tweenValue(this, "style." + name4, value))).each(styleMaybeRemove(this._id, name4)) : this.styleTween(name4, styleConstant2(name4, i2, value), priority).on("end.style." + name4, null);
}

// node_modules/d3-transition/src/transition/styleTween.js
function styleInterpolate(name4, i2, priority) {
  return function(t2) {
    this.style.setProperty(name4, i2.call(this, t2), priority);
  };
}
function styleTween(name4, value, priority) {
  var t2, i0;
  function tween() {
    var i2 = value.apply(this, arguments);
    if (i2 !== i0) t2 = (i0 = i2) && styleInterpolate(name4, i2, priority);
    return t2;
  }
  tween._value = value;
  return tween;
}
function styleTween_default(name4, value, priority) {
  var key = "style." + (name4 += "");
  if (arguments.length < 2) return (key = this.tween(key)) && key._value;
  if (value == null) return this.tween(key, null);
  if (typeof value !== "function") throw new Error();
  return this.tween(key, styleTween(name4, value, priority == null ? "" : priority));
}
...
function transition_default() {
  var name4 = this._name, id0 = this._id, id1 = newId();
  for (var groups = this._groups, m = groups.length, j2 = 0; j2 < m; ++j2) {
    for (var group = groups[j2], n2 = group.length, node, i2 = 0; i2 < n2; ++i2) {
      if (node = group[i2]) {
        var inherit2 = get2(node, id0);
        schedule_default(node, name4, id1, i2, group, {
  ...
  return new Transition(groups, this._parents, name4, id1);
}
...
var id = 0;
function Transition(groups, parents, name4, id2) {
  this._groups = groups;
  this._parents = parents;
  this._name = name4;
  this._id = id2;
}
function transition(name4) {
  return selection_default().transition(name4);
}
function newId() {
  return ++id;
}
...
function transition_default2(name4) {
  var id2, timing;
  if (name4 instanceof Transition) {
    id2 = name4._id, name4 = name4._name;
  } else {
    id2 = newId(), (timing = defaultTiming).time = now(), name4 = name4 == null ? null : name4 + "";
  }
  for (var groups = this._groups, m = groups.length, j2 = 0; j2 < m; ++j2) {
    for (var group = groups[j2], n2 = group.length, node, i2 = 0; i2 < n2; ++i2) {
      if (node = group[i2]) {
        schedule_default(node, name4, id2, i2, group, timing || inherit(node, id2));
      }
    }
  }
  return new Transition(groups, this._parents, name4, id2);
}
...
var b = (0, import_react2.forwardRef)(function({ appearance: e3 = v.button.appearance, tone: t2 = v.button.tone, size: n2 = v.button.size, selected: r2, startIcon: i2, endIcon: a2, children: o2, className: s2, type: c2 = "button", ...l2 }, f2) {
...
var x = (0, import_react2.forwardRef)(function({ "aria-label": e3, title: t2, children: n2, ...r2 }, i2) {
...
function V({ text: e3, children: t2, className: n2, focusable: o2 = true }) {
  let p = (0, import_react2.useId)(), m = (0, import_react2.useRef)(null), h = (0, import_react2.useRef)(null), g = (0, import_react2.useRef)(void 0), [_, v2] = (0, import_react2.useState)(false), y2 = () => clearTimeout(g.current), b2 = () => {
    y2(), v2(true);
  }, x2 = () => {
    y2(), g.current = setTimeout(() => v2(false), 100);
  };
  return (0, import_react2.useEffect)(() => () => clearTimeout(g.current), []), (0, import_react2.useLayoutEffect)(() => {
  ...
  }, [_, e3]), (0, import_react2.useEffect)(() => {
    if (!_) return;
...
var jt = (0, import_react2.memo)(function({ model: e3 }) {
...
function Yt(e3) {
  let t2 = BigInt(e3);
  return t2 === 0n ? "0 ms" : t2 < 1000000n ? "<1 ms" : J(e3);
}
function Xt(e3, t2) {
...
function en() {
  let e3 = "(max-width: 40rem)", [t2, n2] = (0, import_react2.useState)(() => typeof matchMedia == "function" && matchMedia(e3).matches);
...
function gn(e3) {
  let t2 = (0, import_react2.useRef)(null), [n2, i2] = (0, import_react2.useState)(e3);
  return (0, import_react2.useEffect)(() => {
    let e4 = t2.current;
    if (e4 === null) return;
    let n3 = () => {
...
var bn = (0, import_react2.memo)(function({ node: e3, selected: t2, hasChildren: n2, collapsed: r2, onToggle: i2, onSelect: a2, positionInSet: o2, setSize: s2 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function xn({ trace: e3, locale: t2 = "zh-CN", reducedMotion: a2 = false, viewNavigation: l2, showSummary: f2 = true, fillHeight: m = false }) {
  let h = Lt[t2], g = (0, import_react2.useRef)(null), [_, v2] = (0, import_react2.useState)(an);
  ...
  let [b2, C2] = (0, import_react2.useState)(), [w, T2] = (0, import_react2.useState)(""), [E2, D2] = (0, import_react2.useState)(0), [O, k2] = (0, import_react2.useState)(() => /* @__PURE__ */ new Set()), [A2, j2] = (0, import_react2.useState)([0, 100]), M = (0, import_react2.useRef)([0, 100]), [ee, N2] = (0, import_react2.useState)(() => /* @__PURE__ */ new Map()), P2 = (0, import_react2.useRef)(/* @__PURE__ */ new Map()), F2 = (0, import_react2.useId)().replace(/[^a-zA-Z0-9_-]/g, ""), I2 = (0, import_react2.useRef)(void 0), L2 = en(), [te2, R2] = gn(rn), z2 = (0, import_react2.useCallback)((e4) => C2(e4), []), ne2 = (0, import_react2.useMemo)(() => {
  ...
  }, [e3.nodes]), re2 = (0, import_react2.useMemo)(() => w.trim().toLocaleLowerCase(), [w]), ie = (0, import_react2.useMemo)(() => re2 === "" ? e3.nodes : e3.nodes.filter((e4) => e4.label.toLocaleLowerCase().includes(re2) || e4.id.toLocaleLowerCase().includes(re2)), [re2, e3.nodes]), B2 = (0, import_react2.useMemo)(() => re2 !== "" || O.size === 0 ? ie : ie.filter((e4) => {
    let t3 = e4.parentId;
    for (; t3 !== void 0; ) {
    ...
    re2,
    ne2.nodeById
  ]), ae = (0, import_react2.useMemo)(() => e3.durationNano === void 0 ? [] : e3.nodes.map((t3, n2) => {
...
var An = (0, import_react2.memo)(function({ node: e3, trace: t2, onSelect: n2, layout: r2, showLinks: i2 = true, compact: a2 = false }) {
...
var jn = (0, import_react2.memo)(function({ trace: e3, locale: t2 = "zh-CN", reducedMotion: i2 = false, viewNavigation: a2, showSummary: l2 = true }) {
  let f2 = Lt[t2], [p, m] = (0, import_react2.useState)(), [h, g] = (0, import_react2.useState)("none"), [_, v2] = (0, import_react2.useState)(Cn), b2 = (0, import_react2.useRef)(null), C2 = (0, import_react2.useRef)(null), w = (0, import_react2.useRef)(false), T2 = (0, import_react2.useCallback)((e4) => m(e4), []), E2 = en(), D2 = (0, import_react2.useMemo)(() => e3.status === "READY" ? Sn(e3) : [], [e3]), O = (0, import_react2.useMemo)(() => new Map(D2.map((e4) => [e4.node.id, e4])), [D2]), k2 = (0, import_react2.useMemo)(() => new Map(e3.nodes.map((e4) => [e4.id, e4])), [e3.nodes]), A2 = (0, import_react2.useMemo)(() => {
    ...
    return t3;
  }, [e3.nodes]), j2 = k2.get(p ?? "") ?? e3.nodes[0], M = (0, import_react2.useRef)(j2?.id);
  (0, import_react2.useEffect)(() => {
    M.current = j2?.id;
  }, [j2?.id]);
  let ee = i2 ? j2?.id : void 0, N2 = (0, import_react2.useMemo)(() => {
    ...
    k2,
    j2
  ]), P2 = (0, import_react2.useMemo)(() => D2.flatMap((e4) => {
    ...
    h,
    N2
  ]), F2 = (0, import_react2.useMemo)(() => e3.links.flatMap((e4) => {
    ...
    h,
    e3.links
  ]), I2 = (0, import_react2.useMemo)(() => [...P2, ...F2], [F2, P2]), L2 = P2.length > 128, te2 = (0, import_react2.useMemo)(() => {
...
var Mn = Kt;
function Nn({ label: e3, entries: t2, total: n2, totalLabel: r2 }) {
  let i2 = t2.map((e4, r3) => {
    let i3 = n2 === 0n ? 0 : Number(e4.value * 10000n / n2) / 100, a2 = t2.slice(0, r3).reduce((e6, t3) => e6 + (n2 === 0n ? 0 : Number(t3.value * 10000n / n2) / 100), 0);
    return {
      ...e4,
      offset: a2,
      share: i3
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
      ...
      children: [
        ...
        i2.map((e4) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
      ...
      children: i2.map((e4) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
...
function Pn(e3, t2) {
  ...
  let [r2, i2] = n2(e3), [a2, o2] = n2(t2);
  return `M 24 24 L ${r2} ${i2} A 18 18 0 ${+(t2 - e3 > 50)} 1 ${a2} ${o2} Z`;
}
function Fn({ entries: e3, label: t2, total: n2 }) {
  let r2 = e3.map((t3, r3) => {
    let i2 = n2 === 0n ? 0 : Number(t3.value * 10000n / n2) / 100, a2 = e3.slice(0, r3).reduce((e4, t4) => e4 + (n2 === 0n ? 0 : Number(t4.value * 10000n / n2) / 100), 0);
    return {
      ...t3,
      end: n2 > 0n && r3 === e3.length - 1 ? 100 : a2 + i2,
      start: a2
    };
  });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className: "trace-statistics-donut-layout",
    children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
      "aria-label": `${t2} pie chart`,
      className: "trace-statistics-pie",
      "data-chart-type": "pie",
      role: "img",
      viewBox: "0 0 48 48",
      children: r2.map((e4) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
        className: "trace-statistics-color trace-statistics-pie-segment",
        d: Pn(e4.start, e4.end),
        "data-category": e4.category,
        "data-color-index": e4.colorIndex,
        "data-entry-label": e4.label,
...
function In({ entries: e3, label: t2 }) {
  let n2 = e3.reduce((e4, t3) => t3.value > e4 ? t3.value : e4, 0n);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    "aria-label": `${t2} horizontal bar chart`,
    ...
    children: e3.map((e4) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(y, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
          ...
          "data-color-index": e4.colorIndex,
          "data-entry-label": e4.label,
          style: { width: `${Jt(String(e4.value), String(n2))}%` },
...
function Ln({ trace: e3, viewNavigation: t2 }) {
  if (e3.status !== "READY" || e3.durationNano === void 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(vn, { trace: e3 });
  let n2 = e3.nodes.filter(({ status: e4 }) => e4 === "ERROR").length, r2 = e3.nodes.reduce((e4, t3) => BigInt(t3.durationNano) > BigInt(e4) ? t3.durationNano : e4, "0"), i2 = [
    ["Recorded spans", String(e3.nodes.length)],
    ["Recorded links", String(e3.links.length)],
    ["ERROR spans", String(n2)],
    ["Maximum recorded duration", Yt(r2)]
  ], a2 = Object.entries(e3.nodes.reduce((e4, t3) => (e4[t3.status] = (e4[t3.status] ?? 0) + 1, e4), {})), o2 = Object.entries(e3.nodes.reduce((e4, t3) => (e4[t3.kind] = (e4[t3.kind] ?? 0) + 1, e4), {})), s2 = a2.map(([e4, t3], n3) => ({
    category: `status-${e4.toLowerCase()}`,
    colorIndex: n3 % Mn,
    displayValue: String(t3),
    label: e4,
    value: BigInt(t3)
  })), c2 = (e4, t3) => e4 === "INTERNAL" ? 0 : e4 === "CLIENT" ? 3 : t3 % Mn, l2 = o2.map(([e4, t3], n3) => ({
    colorIndex: c2(e4, n3),
    displayValue: String(t3),
    label: e4,
    value: BigInt(t3)
  })), f2 = Object.entries(e3.nodes.reduce((e4, t3) => (e4[t3.kind] = (e4[t3.kind] ?? 0n) + BigInt(t3.durationNano), e4), {})).map(([e4, t3], n3) => ({
    colorIndex: c2(e4, n3),
    displayValue: Yt(String(t3)),
    label: e4,
    value: t3
  })), p = e3.nodes[0], m = e3.nodes.slice(1), h = m.reduce((e4, t3) => e4 + BigInt(t3.durationNano), 0n), g = p !== void 0 && m.length > 0 && BigInt(p.durationNano) === h, _ = new Map(e3.nodes.map((e4) => [e4.id, e4])), v2 = (e4) => {
    let t3 = e4.fields.find(({ field: e6, value: t4 }) => e6 === "crystra.statistics.topic" && typeof t4 == "string" && t4.trim().length > 0)?.value;
    if (typeof t3 == "string") return t3.trim();
    let n3 = e4, r3 = /* @__PURE__ */ new Set();
    for (; n3.parentId !== void 0 && n3.parentId !== p?.id && !r3.has(n3.id); ) {
      r3.add(n3.id);
      let e6 = _.get(n3.parentId);
      if (e6 === void 0) break;
      n3 = e6;
    }
    return n3.label;
  ...
  m.forEach((e4, t3) => {
    let n3 = v2(e4), r3 = b2.get(n3);
    r3 === void 0 ? b2.set(n3, {
      duration: BigInt(e4.durationNano),
      firstIndex: t3,
      nodes: [e4],
      topic: n3
    }) : (r3.duration += BigInt(e4.durationNano), r3.nodes.push(e4));
  });
  let x2 = [...b2.values()], S2 = (x2.length <= 4 ? x2 : (() => {
    let e4 = new Set([...x2].sort((e6, t4) => e6.duration === t4.duration ? e6.firstIndex - t4.firstIndex : e6.duration > t4.duration ? -1 : 1).slice(0, 3).map(({ topic: e6 }) => e6)), t3 = x2.filter(({ topic: t4 }) => e4.has(t4)), n3 = m.filter((t4) => !e4.has(v2(t4)));
    return [...t3, {
      duration: n3.reduce((e6, t4) => e6 + BigInt(t4.durationNano), 0n),
      firstIndex: n3.length,
      nodes: n3,
      topic: "Other"
    }];
  })()).map((e4, t3) => ({
    ...
    entries: e4.nodes.map((e6) => ({
      colorIndex: m.indexOf(e6) % Mn,
      displayValue: Yt(e6.durationNano),
      label: e6.label,
      value: BigInt(e6.durationNano)
    })),
    id: `category-group-${t3 + 1}`,
    label: e4.topic,
    topic: e4.topic
  })), C2 = [...p === void 0 ? [] : [{
    colorIndex: 0,
    ...
    label: e4.label,
    topic: e4.topic
  }))], w = String(C2.reduce((e4, t3) => BigInt(t3.durationNano) > e4 ? BigInt(t3.durationNano) : e4, 0n));
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dl", {
            ...
            children: i2.map(([e4, t3]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
            ...
            }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Fn, {
              entries: l2,
                ...
                children: C2.map((e4) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      ...
                      style: { height: `${Jt(e4.durationNano, w)}%` },
                      title: `${e4.label}: ${Yt(e4.durationNano)}`,
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: Yt(e4.durationNano) })
                    })
                  }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(y, {
                    as: "span",
...
function StudioView(React3, Primitives2, Bi2, sharedStyles, controller, explicitThemeMode, layoutStorage) {
  ...
  return function StudioConversationView() {
    const [technicalDetailsOpen, setTechnicalDetailsOpen] = React3.useState(false);
    const [traceView, setTraceView] = React3.useState("waterfall");
    const [taskQuery, setTaskQuery] = React3.useState("");
    const [filtersOpen, setFiltersOpen] = React3.useState(false);
    const [taskFilter, setTaskFilter] = React3.useState("all");
    const [editingDashboard, setEditingDashboard] = React3.useState(false);
    const snapshot = React3.useSyncExternalStore(controller.subscribe, controller.getSnapshot, controller.getSnapshot);
    const [studioPage, setStudioPage] = React3.useState(() => snapshot.result !== void 0 || ["receipt", "facts", "trace"].includes(snapshot.route.page) ? "dashboard" : "selection");
    const [selectionRequested, setSelectionRequested] = React3.useState(false);
    React3.useEffect(() => {
    ...
    const json = (data, label) => JsonTree2 === void 0 ? React3.createElement("pre", { "aria-label": label }, JSON.stringify(data, null, 2)) : React3.createElement(JsonTree2, { data, label, copyable: true, expandTopLevel: true });
    ...
    const [dashboardState, setDashboardState] = React3.useState(() => layoutStore.load(createStudioDashboardState(DEFAULT_LAYOUT.panels.map(({ id: id2 }) => id2))));
    const [savedDashboardState, setSavedDashboardState] = React3.useState(dashboardState);
    ...
    const traceViewNavigation = React3.createElement(
      "nav",
      ...
      React3.createElement(
        ...
        ...STUDIO_TRACE_VIEWS.map((view) => React3.createElement(Button2, { appearance: "segment", key: view.id, selected: traceView === view.id, type: "button", onClick: () => setTraceView(view.id) }, view.label))
      ),
      React3.createElement(Typography, { as: "span", className: "studio-trace-view-note", variant: "caption" }, traceViewDefinition.note)
    );
    return React3.createElement(Bi2.BiSurface, { className: "studio-theme-root", theme }, React3.createElement(
      "section",
      {
      ...
      React3.createElement("style", { "data-crystra-studio-host-styles": "crystra-dsh@1" }, hostStyles),
      sharedStyles === void 0 ? null : React3.createElement("style", { "data-crystra-bi-styles": "crystra-ui-core@0.1.0" }, sharedStyles),
      React3.createElement(
        Surface,
        ...
        React3.createElement(
          ...
          React3.createElement(
            ...
            React3.createElement(Typography, { as: "strong", variant: "label" }, "CRYSTRA Studio"),
            React3.createElement(Typography, { variant: "caption" }, "/"),
            React3.createElement(Typography, { variant: "caption" }, "Evaluation"),
            snapshot.route.page === "trace" ? React3.createElement(
              React3.Fragment,
              null,
              React3.createElement(Typography, { variant: "caption" }, "/"),
              React3.createElement(Typography, { variant: "caption" }, "Trace")
            ) : null
          ),
          React3.createElement(
            "nav",
            { className: "studio-controls", "aria-label": "Studio views" },
            React3.createElement(Button2, { appearance: "ghost", className: "studio-view-link", type: "button", disabled: false, "aria-current": studioPage === "selection" ? "page" : void 0, onClick: () => {
              setSelectionRequested(true);
              setStudioPage("selection");
            } }, "Select"),
            React3.createElement(Button2, { appearance: "ghost", className: "studio-view-link", type: "button", disabled: snapshot.result === void 0 && !["receipt", "facts", "trace"].includes(snapshot.route.page), "aria-current": studioPage === "dashboard" && snapshot.route.page === "results" ? "page" : void 0, onClick: () => {
        ...
        React3.createElement(
          ...
          React3.createElement(
            ...
            React3.createElement(Typography, { as: "span", className: "studio-eyebrow", variant: "eyebrow" }, pageIdentity.eyebrow),
            React3.createElement(Typography, { as: "h1", id: "crystra-studio-title", variant: "pageTitle" }, pageIdentity.title),
            React3.createElement(Typography, { as: "p", variant: snapshot.route.page === "trace" ? "code" : "caption" }, pageIdentity.detail)
          ),
          React3.createElement(
            ButtonGroup,
            { className: "studio-controls studio-page-actions", "aria-label": "Page actions" },
            studioPage === "selection" ? React3.createElement(
              React3.Fragment,
              null,
              React3.createElement(Button2, { appearance: "ghost", type: "button", disabled: snapshot.recentSelection === void 0, onClick: () => controller.setSelection(snapshot.recentSelection) }, "Use recent selection"),
              React3.createElement(Button2, { appearance: "outline", type: "button", disabled: snapshot.taskList.phase === "loading", onClick: () => controller.loadTasks() }, "Load tasks"),
              React3.createElement(Button2, { appearance: "solid", tone: "primary", type: "button", disabled: snapshot.selection === void 0, onClick: evaluateSelection }, "Evaluate selection")
            ) : null,
            studioPage === "dashboard" && snapshot.route.page === "results" ? React3.createElement(
              React3.Fragment,
              null,
              snapshot.result === void 0 ? null : React3.createElement(Button2, { type: "button", onClick: () => controller.openReceipt() }, "View receipt"),
              React3.createElement(Button2, { type: "button", onClick: () => setDashboardState(reduceStudioDashboardState(expandedDashboardState, { type: "PRESET", preset: "default" })) }, "Default overview"),
              React3.createElement(Button2, { type: "button", onClick: () => {
                setSelectionRequested(true);
                setStudioPage("selection");
              } }, "Change evaluation")
            ) : null,
            studioPage === "dashboard" && snapshot.route.page === "trace" ? React3.createElement(
              React3.Fragment,
              null,
              React3.createElement(Button2, { appearance: "outline", type: "button", onClick: () => controller.backToResults() }, "Back to Dashboard"),
              React3.createElement(Button2, {
                appearance: "outline",
                type: "button",
                disabled: evidenceUnavailableReason !== void 0,
              ...
              React3.createElement(Button2, { appearance: "solid", tone: "primary", type: "button", onClick: () => navigator.clipboard?.writeText(snapshot.route.traceId) }, "Copy trace identity")
            ) : null,
            studioPage === "dashboard" && editingDashboard ? React3.createElement(
              React3.Fragment,
              null,
              React3.createElement(Button2, { type: "button", onClick: () => setDashboardState(reduceStudioDashboardState(expandedDashboardState, { type: "RESET" })) }, "Reset layout"),
              React3.createElement(Button2, { appearance: "solid", tone: "primary", type: "button", onClick: () => {
                layoutStore.save(expandedDashboardState);
                setSavedDashboardState(expandedDashboardState);
                setEditingDashboard(false);
              } }, "Save layout"),
              React3.createElement(Button2, { appearance: "ghost", type: "button", onClick: () => {
                setDashboardState(savedDashboardState);
                setEditingDashboard(false);
              } }, "Cancel editing")
            ) : studioPage === "dashboard" && snapshot.route.page === "results" ? React3.createElement(Button2, { appearance: "solid", tone: "primary", type: "button", onClick: () => {
              setSavedDashboardState(expandedDashboardState);
              setEditingDashboard(true);
            } }, "Edit dashboard") : null
          )
        ),
        studioPage === "dashboard" && editingDashboard && metricPanelIds.some((id2) => expandedDashboardState.hidden.includes(id2)) ? React3.createElement(
          "div",
          { className: "studio-controls", "aria-label": "Add dashboard panels" },
          ...metricPanelIds.filter((id2) => expandedDashboardState.hidden.includes(id2)).map((panelId) => React3.createElement(Button2, { key: panelId, type: "button", onClick: () => updateDashboard({ type: "ADD", panelId }) }, `Add ${panelId}`))
        ) : null
      ),
      React3.createElement(
        "main",
        ...
        snapshot.phase === "loading" || snapshot.refreshing ? React3.createElement("p", { role: "status", "aria-live": "polite" }, snapshot.refreshing ? "Refreshing evaluation\u2026" : "Loading evaluation\u2026") : null,
        snapshot.error === void 0 ? null : React3.createElement(
          "section",
          { role: "alert", "aria-live": "assertive" },
          React3.createElement("h2", null, snapshot.result === void 0 ? "Evaluate unavailable" : "Showing the last result"),
          React3.createElement("p", null, snapshot.error.message),
          React3.createElement(Button2, { type: "button", style: controlStyle, onClick: () => controller.refresh() }, "Retry")
        ),
        studioPage === "selection" ? React3.createElement(
          "section",
          {
          ...
          React3.createElement(
            ...
            React3.createElement(
              ...
              React3.createElement(
                "div",
                null,
                React3.createElement(Typography, { as: "h2", id: "crystra-task-selection", variant: "sectionTitle" }, "Task population"),
                React3.createElement(Typography, { as: "p", className: "studio-selection-copy", variant: "caption" }, `${taskItems.length} Tasks \xB7 exact identities retained in the receipt`)
              ),
              React3.createElement(
                ButtonGroup,
                { segmented: true, className: "studio-mode", "aria-label": "Evaluation mode" },
                React3.createElement(Button2, { appearance: "segment", selected: snapshot.selection?.mode !== "compare", type: "button", onClick: () => chooseMode("single") }, "Single"),
                React3.createElement(Button2, { appearance: "segment", selected: snapshot.selection?.mode === "compare", type: "button", onClick: () => chooseMode("compare") }, "Compare")
              )
            ),
            React3.createElement(
              "div",
              { className: "studio-selection-filter" },
              React3.createElement(TextInput, { inputKind: "search", "aria-label": "Search Tasks", placeholder: "Search name or exact Task ID", value: taskQuery, onChange: (event) => setTaskQuery(event.target.value) }),
              React3.createElement(Button2, { type: "button", "aria-expanded": filtersOpen, onClick: () => setFiltersOpen(!filtersOpen) }, "Filters"),
              filtersOpen ? React3.createElement(
                "div",
                { className: "studio-filter-options", role: "group", "aria-label": "Task filters" },
                ...[["all", "All"], ["selected", "Selected"], ["available", "Available"]].map(([value, label]) => React3.createElement(Button2, { key: value, type: "button", "aria-pressed": taskFilter === value, onClick: () => setTaskFilter(value) }, label)),
                snapshot.taskList.page?.next_cursor ? React3.createElement(Button2, { type: "button", onClick: () => controller.loadTasks(snapshot.taskList.page.next_cursor) }, "Load more tasks") : null
              ) : null
            ),
            snapshot.taskList.phase === "error" ? React3.createElement("p", { role: "alert" }, "Task list unavailable; the current selection remains usable.") : null,
            snapshot.selection?.mode === "compare" ? React3.createElement("div", { className: "studio-task-list" }, ...[["Before", "left", before], ["After", "right", after]].flatMap(([label, side2, selected]) => [
              React3.createElement(Typography, { as: "strong", key: `${side2}-label`, variant: "label" }, label),
              ...visibleTaskItems.map((task) => React3.createElement(
                "div",
                { className: "studio-task-row", "data-crystra-selection-side": side2, "data-crystra-task-id": task.task_id, key: `${side2}-${task.task_id}` },
                React3.createElement(
                  "label",
                  null,
                  React3.createElement("input", { type: "checkbox", checked: selected.includes(task.task_id), onChange: (event) => setComparedTask(side2, task.task_id, event.target.checked) }),
                  React3.createElement(
                    "span",
                    null,
                    React3.createElement(Typography, { as: "strong", variant: "label" }, task.display_name ?? task.task_id),
                    React3.createElement(Typography, { as: "small", className: "studio-task-id", variant: "code" }, task.task_id)
                  )
                ),
                React3.createElement(StatusBadge, { status: selected.includes(task.task_id) ? "selected" : "available" }, selected.includes(task.task_id) ? "Selected" : "Available")
              ))
            ])) : React3.createElement("div", { className: "studio-task-list", role: "list" }, ...visibleTaskItems.map((task) => React3.createElement(
              "div",
              { className: "studio-task-row", "data-crystra-task-id": task.task_id, key: task.task_id, role: "listitem" },
              React3.createElement(
                "label",
                null,
                React3.createElement("input", { type: "checkbox", checked: current.includes(task.task_id), onChange: (event) => setTask(task.task_id, event.target.checked) }),
                React3.createElement(
                  "span",
                  null,
                  React3.createElement(Typography, { as: "strong", variant: "label" }, task.display_name ?? task.task_id),
              ...
              React3.createElement(StatusBadge, { status: current.includes(task.task_id) ? "selected" : "available" }, current.includes(task.task_id) ? "Selected" : "Available")
            ))),
            snapshot.taskList.phase === "ready" && taskItems.length === 0 ? React3.createElement("p", { role: "status" }, "No Tasks are available in Evidence.") : null
          ),
          React3.createElement(
            Surface,
            ...
            React3.createElement(
              ...
              React3.createElement(
                "div",
                null,
                React3.createElement(Typography, { as: "h2", variant: "sectionTitle" }, "Current selection"),
                React3.createElement(Typography, { as: "p", className: "studio-selection-copy", variant: "caption" }, snapshot.selection?.mode === "compare" ? `${before.length} Before \xB7 ${after.length} After` : `Single evaluation \xB7 ${current.length} ${current.length === 1 ? "Task" : "Tasks"}`)
              ),
              React3.createElement(Button2, { appearance: "ghost", type: "button", disabled: snapshot.selection === void 0, onClick: () => controller.clearSelection() }, "Clear")
            ),
            React3.createElement(
              "div",
              ...
              ...(snapshot.selection?.mode === "compare" ? [["Before", before], ["After", after]] : [["Selected", current]]).flatMap(([label, ids]) => [
                React3.createElement(Typography, { as: "strong", key: `${label}-heading`, variant: "label" }, label),
                ...ids.map((id2) => {
                  const task = taskItems.find((candidate) => candidate.task_id === id2);
                  return React3.createElement(
                    "div",
                    { className: "studio-selected-item", key: `${label}-${id2}` },
                    React3.createElement(Typography, { as: "strong", variant: "label" }, task?.display_name ?? id2),
                    React3.createElement(Typography, { as: "small", className: "studio-task-id", variant: "code" }, id2)
                  );
                })
              ]),
              React3.createElement(Typography, { as: "p", className: "studio-selection-copy", variant: "caption" }, "Evaluation resolves a current receipt. Layout and display names do not enter evaluation identity.")
            )
          )
        ) : null,
        studioPage !== "dashboard" || snapshot.route.page !== "results" ? null : snapshot.result === void 0 ? React3.createElement("p", null, "Choose one or more Tasks to evaluate.") : React3.createElement(
          "section",
          { "aria-label": snapshot.result.mode === "COMPARE" ? "Compared Metric Results" : "Metric Results" },
          snapshot.phase === "partial" ? React3.createElement("p", { role: "status" }, "Partial comparison: the available side remains visible.") : null,
          React3.createElement(
            Bi2.BiSurface,
            { theme },
            React3.createElement("div", {
              ...
              return React3.createElement(
                ...
                editingDashboard ? React3.createElement(
                  "div",
                  { className: "studio-controls", "aria-label": `${panelId} layout controls` },
                  React3.createElement(Button2, { type: "button", onClick: () => updateDashboard({ type: "RESIZE", panelId, size: placement.desktop >= 12 ? "compact" : placement.desktop >= 6 ? "full" : "wide" }) }, "Resize panel"),
                  React3.createElement(Button2, { type: "button", onClick: () => {
                  ...
                  React3.createElement(Button2, { type: "button", onClick: () => updateDashboard({ type: "REMOVE", panelId }) }, "Remove panel")
                ) : null,
                snapshot.result.mode === "COMPARE" ? React3.createElement("h3", null, metric.coordinate) : null,
                ...metric.sides.map(({ side: side2, slices }) => {
                  ...
                  return React3.createElement(
                    ...
                    snapshot.result.mode === "COMPARE" ? React3.createElement("h4", null, `${side2} side`) : null,
                    React3.createElement(Bi2.DashboardMetricPanel, {
                      result,
            ...
            ...snapshot.result.mode === "COMPARE" ? presentation.deltas.map((delta) => {
              ...
              return React3.createElement(Bi2.CompareResultFrame, {
        ...
        studioPage === "dashboard" && snapshot.route.page === "receipt" ? React3.createElement(
          "section",
          { "aria-label": "Evaluation receipts" },
          React3.createElement("h2", null, "Receipts"),
          React3.createElement(Button2, { type: "button", onClick: () => controller.backToResults() }, "Back to Metric Results"),
          React3.createElement(
            Bi2.BiSurface,
            { theme },
            ...presentation.receipts.map(({ side: side2, receipt }) => React3.createElement(Bi2.ReceiptView, {
              key: side2,
              receipt,
              side: side2
            }))
          ...
          React3.createElement(
            ...
            React3.createElement("summary", null, "Technical JSON details"),
            technicalDetailsOpen ? json(snapshot.result, "Evaluation receipt JSON") : null
          )
        ) : null,
        studioPage === "dashboard" && snapshot.route.page === "facts" ? React3.createElement(
          "section",
          ...
          React3.createElement(
            Bi2.BiSurface,
            { theme },
            React3.createElement(Bi2.EvidenceConsoleFoundation, {
        ...
        studioPage === "dashboard" && snapshot.route.page === "trace" ? React3.createElement(
          ...
          presentation.drilldownError === void 0 ? null : React3.createElement("p", { role: "alert" }, presentation.drilldownError.message),
          recorded === void 0 ? React3.createElement(
            "p",
            ...
            React3.createElement(
              ...
              recorded.status === "INVALID" ? React3.createElement("p", { role: "alert" }, recorded.errors.join("; ")) : null,
              traceViewNavigation,
              React3.createElement(Bi2[STUDIO_TRACE_VIEWS.find(({ id: id2 }) => id2 === traceView)?.renderer ?? "TraceWaterfall"], {
                trace: recorded
              })
            )
          )
      ...
      studioPage === "dashboard" && snapshot.route.page === "results" && snapshot.result !== void 0 ? React3.createElement(
        Surface,
        { as: "footer", border: "dashed", level: "raised", "data-crystra-studio-region": "footer" },
        React3.createElement(Typography, { as: "strong", variant: "label" }, presentation.trace.length > 0 ? "Recorded Trace is available" : "Recorded Trace availability follows current Evidence"),
        React3.createElement(Typography, { variant: "caption" }, " \xB7 exact recorded identities only; no inferred ordering")
      ) : null
    ));
  };
}
function createStudioClientPlugin({ React: React3, Primitives: Primitives2 = {}, Bi: Bi2, sharedStyles, initialContext, storage, themeMode } = {}) {
  if (React3 === void 0) throw new Error("STUDIO_REACT_REQUIRED");
  ...
  return {
    ...
    apply(ctx) {
      ...
      ctx.slots.inject("conversation.view", () => {
        ...
        }, StudioView(React3, Primitives2, Bi2, sharedStyles, controller, themeMode, resolvedStorage));
      });
...
var plugin = createStudioClientPlugin({ React: import_react3.default, Primitives, Bi, sharedStyles: styles_default });
var name2 = plugin.name;
var inject2 = plugin.inject;
var apply2 = plugin.apply;

// src/client/index.js
var name3 = "crystra-client";
var inject3 = [.../* @__PURE__ */ new Set([...inject, ...inject2])];
function apply3(ctx) {
